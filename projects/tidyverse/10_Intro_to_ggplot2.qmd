...
- The second command installs some datasets we will use 
from Rafael Irizarry's book on Data Science. 


## Credit

![](images/irizarry.jpg){fig-align="center" width="300"}
...
-   Rafa also has teaches bioinformatics courses on EdX, including Data Science-specific and Genomics-specific ones. Check them out! 
...
-   ggplot2 is designed to work with *tidy data* (we'll get into this later).
...
::: footer
[https://stackoverflow.com/questions/67633022/what-are-the-differences-between-rs-new-native-pipe-and-the-magrittr-pipe](https://stackoverflow.com/questions/67633022/what-are-the-differences-between-rs-new-native-pipe-and-the-magrittr-pipe)
:::

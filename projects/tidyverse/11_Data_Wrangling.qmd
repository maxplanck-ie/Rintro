...
## A brief note on non-standard evaluation
...
## What is the average daily salary of a German person in 1989 (use gdp)? {auto-animate="true"}
...
## Rank the following countries based on their mortality rate in 2012. {auto-animate="true"}
...
## What are the seven regions with lowest median life expectancy between 2000-2009? {auto-animate="true"}

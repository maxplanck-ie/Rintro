...
The first step for any analysis is importing the data 
into a machine-readable format. The tidyverse offers
the `readr::` and `readxl::` packages, as we have just recently seen. 
...
- `readr::` is the Tidyverse library for reading data 
from text formats. 
- `read_csv()`, `read_tsv()`, `read_table()`, and `read_delim()` are 
...
- `readxl::` is the Tidyverse library for reading data 
from Excel formats. 
...
We will next talk about how to manipulate data in data frames using the Tidyverse. 
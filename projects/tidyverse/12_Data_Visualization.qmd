...
- Each geometry function has its own arguments that can be used
to tinker with the visualization
...
## Exercise: make a boxplot of daily salary by region in 1970! {auto-animate="true"}

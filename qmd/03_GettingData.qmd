...
## R markdown & reproducible R

It is important to document your work and workflows.

One common solutions is to write a script (e.g. my_script.R) that can run a series of commands.
...
A modern solution are R/Quarto markdown documents (*rmd/*qmd). 

...
Why are we using "escaped" numbers?
...
At the end, we would like to save our gorgeous plot, we can use `ggsave()`, defining file location, dpi and size.

It automatically detect the file type by the extension (png, jpg/jpeg, pdf, svg, ...) and export in that format.

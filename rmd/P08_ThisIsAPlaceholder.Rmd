...
But, you can also do it by combining lapply + shaping/casting your data, e.g.:
...
#Task5
Visualize all pairwise intersects between age categories in both replicates.
...
upset(fromList(newL),nsets=length(newL),nintersects=NA, order.by = "freq",matrix.color="darkslategrey",main.bar.color="darkslategrey",mainbar.y.label = "Common CDR3 Intersections", sets.x.label = "Common CDR3 variants per mouse")
#dev.off()

...
**Bayes Theorem** (on updating probabilities): 
$$
...
$$
Pr(2=shown) = \sum_A Pr(2=shown|A) = \\
Pr(2=shown|1=car)Pr(1=car) + Pr(2=shown|2=car)Pr(2=car) + Pr(2=shown|3=car)Pr(3=car) \\
...
Pr(1=car|2=shown)= 1 - Pr(2=car|2=shown) - Pr(3=car|2=shown)= \\

...
# Create R project
It is good practice that each R project should have their dedicated directory.
This directory will hold code, data, results etc.
...
Software depends on other software and libraries.
...
* use help to understand about functions: ?sqrt

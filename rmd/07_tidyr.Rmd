---
title: "07: Tidyr - dealing with messy data"
...
In case you are not using Workbench, please install the following packages:
...
- This course content has been evolving since its conception
- It is heavily influenced by Rafael Irizarry's book "*Introduction to Data Science*" and his corresponding course on EdX.
- It also draws on material from previous MPI R-courses by
  - Devon Ryan
  - David Koppstein
...
- Even worse if humans capture the data manually

This **always** happens with other's datasets.

The process of correcting all of this is called **data munging**.
...
- Everyone likes doing crazy stuff in Excel
  ...
  - Also, Excel it's dangeorus (*Genes* as *Dates*) and should be avoided if possible
...
# Real example: MouseFoodExperiment
- Open the *../data/MouseFoodExperiment.xlsx* file in Excel/LibreOffice
...
```{r, echo=TRUE}
# We've taken care of changing "," to ".", since this sometimes causes problems,
...
>- More typing...
>- but more logical
>- also it is based on *data flows|streams*

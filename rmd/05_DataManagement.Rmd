...
### Mock real
```{r, eval=FALSE}
file="~/Google Drive/talks/lectures/Rintro/data/GeneList.tsv"
read.table(file) 
...
### Real real
Notice1: The following code fragments took ~2 hours of trial and error. It is kept here for reference. No need to execute
...
colnames(D)[1:4]=H[1,1:4]  # the first 4 headers got skipped from D, use entries from H
rownames(D)=D[,1]          # ORF-symbols
ic=c(1:4,seq(6,230,by=2))  # define indices to be excluded

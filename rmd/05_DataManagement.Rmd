...
Notice: While R can conveniently read from URL, for slow network connections, it maybe easier to first download the file to local storage and work from there.

Notice2: The following code is just for illustration, no need to execute.
```{r, eval=FALSE}
...
So let's start with a cleaned-up data set "../data/chip.tsv"
```{r}
P=read.table(file="../data/chip.tsv", header=TRUE, sep="\t")
